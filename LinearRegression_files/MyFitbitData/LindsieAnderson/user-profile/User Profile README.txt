...
Your profile data is represented as follows, with absent fields represented by "null":
    ...
    height                  - the height set in your profile settings, in your height unit system (e.g. inches)
    weight                  - the weight set in your profile settings, in grams
    stride_length_walking   - the walking stride length used for your account, in your distance unit system (e.g. inches)
    stride_length_running   - the running stride length used for your account, in your distance unit system (e.g. inches)
